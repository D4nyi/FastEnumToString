...
namespace FastEnumToString
{
    ...
    public class EnumToStringGenerator : ISourceGenerator
    {
        ...
        public void Execute(GeneratorExecutionContext context)
        {
            ...
            var namespaces = new StringBuilder(reciever.FoundEnums.Count * (usingTemplate.Length + 35));
            ...
            foreach (EnumDeclarationSyntax syntax in reciever.FoundEnums)
            {
                ...
                try
                {
                    ...
                    GenerateSource(symbol, syntax, namespaces, methods);
                }
                catch (Exception ex)
                {
        ...
        private static void GenerateSource(ISymbol symbol, EnumDeclarationSyntax syntax, StringBuilder namespaces, StringBuilder methods)
        {
            namespaces.AppendFormat(usingTemplate, symbol.ContainingNamespace);
