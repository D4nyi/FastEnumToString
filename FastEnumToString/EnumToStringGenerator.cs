...
namespace FastEnumToString
{
    ...
    public class EnumToStringGenerator : ISourceGenerator
    {
        ...
        private const string SelfFullName = nameof(FastEnumToString) + "." + nameof(EnumToStringGenerator);
        ...
        public void Execute(GeneratorExecutionContext context)
        {
            ...
            string generatedCodeAttr = "\r\n[global::System.CodeDom.Compiler.GeneratedCodeAttribute(\"" + SelfFullName + "\", \"" + (version == null ? "" : version.ToString()) + "\")]";

            if (reciever.FoundEnums.Count == 0)
            {
                context.AddSource(GeneratedFileName,AutoGenComment + generatedCodeAttr + ClassStart + NoContentComment + '}');
                return;
            }

            int methodLengthEstimation = BodyNSwitchStart.Length + SwitchNBodyEnd.Length + MethodDeclaration.Length + 16 + 8 * (SwicthArm.Length + 25);
            ...
            string generatedClass = new StringBuilder(AutoGenComment.Length + usings.Length + generatedCodeAttr.Length + ClassStart.Length + methods.Length + 1)
